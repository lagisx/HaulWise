...
public class UserCargoCardController {
    ...
    @FXML
    public Label vesObemLabel;
    @FXML
    public Label tovarLabel;
    @FXML
    public Label dateValue;
    @FXML
    public Label cargoTypeLabel;
    @FXML
    public Label priceKartaLabel;
    @FXML
    public Label priceNDSLabel;
    @FXML
    public Label contactLabel;
    @FXML
    public Label tradeLabel;
    @FXML
    public ImageView randomImageOnCard;
    ...
    @FXML
    public Button removeFromFavButton;
    @FXML
